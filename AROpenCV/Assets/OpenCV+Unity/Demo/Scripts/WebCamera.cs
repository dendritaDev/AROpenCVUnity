	...
	public abstract class WebCamera: MonoBehaviour
	{
		...
		public string DeviceName
		{
			...
			set
			{
				...
				if (-1 != cameraIndex)
				{
					cameraIndex = 0; //modifico esto para hacer que coja la primera camará que se encuentre, ya que lo que está intentando es coger una cámara frontal, q obviamente no hay en el pc
